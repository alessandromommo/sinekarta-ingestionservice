...
public class MdSecType {
    ...
    public static class MdRef {
        ...
        /**
         * Recupera il valore della proprietà labeLmdRef.
         * 
         * @return
         *     possible object is
         *     {@link String }
         *     
         */
        public String getLABELmdRef() {
            return labeLmdRef;
        }

        /**
         * Imposta il valore della proprietà labeLmdRef.
         * 
         * @param value
         *     allowed object is
         *     {@link String }
         *     
         */
        public void setLABELmdRef(String value) {
            this.labeLmdRef = value;
        }
    ...
    public static class MdWrap {
        ...
        /**
         * Recupera il valore della proprietà labeLmdWrap.
         * 
         * @return
         *     possible object is
         *     {@link String }
         *     
         */
        public String getLABELmdWrap() {
            return labeLmdWrap;
        }

        /**
         * Imposta il valore della proprietà labeLmdWrap.
         * 
         * @param value
         *     allowed object is
         *     {@link String }
         *     
         */
        public void setLABELmdWrap(String value) {
            this.labeLmdWrap = value;
        }
